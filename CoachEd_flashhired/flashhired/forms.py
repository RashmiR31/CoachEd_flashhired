...
from .models import User,Candidate, Recruiter, JobPosting,Accomplishments,Projects,Experience,Languages,Skills
...
class CandidateLanguagesForm(forms.ModelForm):
    class Meta:
        model= Languages
        fields = '__all__'
        exclude=('candidate',)
